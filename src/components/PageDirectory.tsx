...
export default function pageDirectory({ projects, fullSize, hasLogo }: { projects: any, fullSize: boolean, hasLogo: boolean }) {
  ...
  return (
    <div style={fullSize ? { width: "100%", margin: 0, padding: 0} : { width: "100%", position: "absolute", top: "0", left: "0", margin: 0, padding: 0}}>
      ...
      <ul
        className="hideable"
        style={fullSize ? { margin: "0", padding: "0", display: "flex", justifyContent: "start", alignItems: "center", flexDirection: "column", width: "100%", position: "relative" } : { overflowY: "scroll", maxHeight: "100vh", top: "0", left: "0", padding: "20px", backgroundColor: "#0F0F26", color: "#ffffff", borderColor: "#ffffff", borderWidth: "1px", borderStyle: "solid", display: "flex", justifyContent: "start", alignItems: "center", flexDirection: "column", position: "fixed", margin: "0" }}
      >
